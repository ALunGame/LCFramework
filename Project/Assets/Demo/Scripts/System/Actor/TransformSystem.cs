...
namespace Demo.System
{
    public class TransformSystem : BaseSystem
    {
        ...
        {
            //TransCom transCom = GetCom<TransCom>(comList[0]);
        ...
        //private void HandleDir(TransCom transCom)
        //{
        ...
        //private void HandleMove(TransCom transCom, Collider2DCom collider2DCom, AnimCom animCom)
        //{
