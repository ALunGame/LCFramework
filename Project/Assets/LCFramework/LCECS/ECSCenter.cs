...
namespace LCECS
{
    ...
    {
        public bool OpenGizmos = true;
        private List<Action> DrawGizmosFuncList = new List<Action>();
        ...
        private void OnDrawGizmos()
        {
            ...
            for (int i = 0; i < DrawGizmosFuncList.Count; i++)
            {
                DrawGizmosFuncList[i]?.Invoke();
            }
        }

        public void AddDrawGizmosFunc(Action drawFunc)
        {
            DrawGizmosFuncList.Add(drawFunc);
        }
    }
}
