...
namespace Scenes.Move
{
    ...
    public class PlayerMoveCollider
    {
        ...
        private ColliderCheckInfo UpCheckInfo    = new ColliderCheckInfo();
        private ColliderCheckInfo DownCheckInfo  = new ColliderCheckInfo();
        private ColliderCheckInfo LeftCheckInfo  = new ColliderCheckInfo();
