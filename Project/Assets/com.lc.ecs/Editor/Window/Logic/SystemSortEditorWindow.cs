...
public class SystemSortEditorWindow : EditorWindow
{
    ...
    static void OpenWindow()
    {
        if (EDTool.CheckFileInPath(Application.dataPath + JsonPath))
        {
            ...
            MSystemSortJson = JsonMapper.ToObject<SystemSortJson>(dataJson);
        }
    ...
    private const string JsonPath = "/" + ECSDefPath.SystemSortPath;
    ...
    {
        string jsonData = JsonMapper.ToJson(MSystemSortJson);
