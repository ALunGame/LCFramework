...
namespace LCECS.Server.Layer
{
    public class RequestServer : IRequestServer
    {
        ...
        public void Init()
        {
            TextAsset jsonData = ECSLocate.Factory.GetProduct<TextAsset>(FactoryType.Asset, null, ECSDefPath.LogicReqWeightPath);
        ...
        public int GetRequestWeight(int reqId)
        {
            ...
            ECSLocate.Log.LogR("有实体请求没有设置权重>>>>", reqId.ToString());
            return 0;
        }
