...
namespace LCTimeline.View
{
    ...
    /// 序列视图（一个序列包含多个轨道）
    /// </summary>
    [TimelineView(typeof(TimelineData))]
    public class BaseSequenceView : BaseTimelineView
    {
        ...
        public override void OnDraw()
        {
            ...
            },GUILayout.Width(SequenceViewRect.width), GUILayout.Width(SequenceViewRect.height));
        ...
        {
            TimelineData sequenceData = (TimelineData)Data;
        ...
        {
            InspectorExtension.DrawObjectInInspector(Data);
        }
