...
namespace LCTimeline.View
{
    class TimeAreaShowHelper
    {
        ...
        public TimeAreaShowHelper(bool v)
        {
            ...
            timeFormatType = t.GetNestedType("TimeFormat", BindingFlags.Public);
        ...
        internal void TimeRuler(Rect position, float frameRate)
        {
        ...
        internal void TimeRuler(Rect position, float frameRate, bool labels, bool useEntireHeight, float alpha, TimeFormatStyle timeFormat)
        {
            object formatValue = Enum.Parse(timeFormatType, timeFormat.ToString());
            MethodInfo oMethod = t.GetMethod("TimeRuler", new Type[] { typeof(Rect), typeof(float), typeof(bool), typeof(bool), typeof(float), timeFormatType });
            oMethod.Invoke(timeArea, new Object[] { position, frameRate, labels, useEntireHeight, alpha, formatValue });
        }
